...
class Attendance :
    def __init__(self,root):
        ...
        img=Image.open(r"c:\Users\dell\Desktop\Face Recognition system\college_images\smart-attendance.jpg")
        ...
        img1=Image.open(r"c:\Users\dell\Desktop\Face Recognition system\college_images\iStock-182059956_18390_t12.jpg")
        ...
        f_lbl.place(x=800,y=0,width=800,height=200)
         ...
         #########3Background image
        img3=Image.open(r"c:\Users\dell\Desktop\Face Recognition system\college_images\bg1.jpg")
        ...
        main_frame.place(x=5,y=55,width=1550,height=600)
        ...
        attendanceid_entery=ttk.Entry(left_inside_frame,textvariable= self.var_atten_id,width=20,font=("times new roman",13,"bold"))
        attendanceid_entery.grid(row=0,column=1,padx=10,pady=5,sticky=W)
        ...
        atten_roll_entery=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_roll,font=("times new roman",13,"bold"))
        atten_roll_entery.grid(row=0,column=3,pady=5)
        
        ###date
        name_label=Label(left_inside_frame,text="Name",font=("times new roman",13,"bold"),bg="white")
        name_label.grid(row=1,column=0)
        
        atten_name_entery=ttk.Entry(left_inside_frame,textvariable=self.var_atten_name,width=22,font=("times new roman",13,"bold"))
        atten_name_entery.grid(row=1,column=1,pady=8)
        #Dept
        
        dep_label=Label(left_inside_frame,text="Department",font=("times new roman",13,"bold"),bg="white")
        dep_label.grid(row=1,column=2)
        
        atten_dep_entery=ttk.Entry(left_inside_frame,textvariable=self.var_atten_dep,width=22,font=("times new roman",13,"bold"))
        atten_dep_entery.grid(row=1,column=3,pady=8)
        ...
        atten_time_entery=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_time,font=("times new roman",13,"bold"))
        atten_time_entery.grid(row=2,column=1,pady=8)
        ...
        atten_date_entery=ttk.Entry(left_inside_frame,width=22,textvariable=self.var_atten_date,font=("times new roman",13,"bold"))
        atten_date_entery.grid(row=2,column=3,pady=8)
        
        ####Attendance
        attendancee_label=Label(left_inside_frame,text="Attendance Status",font=("times new roman",13,"bold"),bg="white")
        attendancee_label.grid(row=3,column=0)
        
        
        self.atten_status=ttk.Combobox(left_inside_frame,font=("times new roman",13,"bold"),width=20,textvariable=self.var_atten_attendence,state="read only")
