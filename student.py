...
class Student :
    def __init__(self,root):
        ...
        ######3First Image 
        img=Image.open(r"C:\Users\dell\Desktop\Face Recognition system\college_images/face-recognition.png")
        ...
        img1=Image.open(r"C:\Users\dell\Desktop\Face Recognition system\college_images/smart-attendance.jpg")
        ...
        img2=Image.open(r"C:\Users\dell\Desktop\Face Recognition system\college_images/iStock-182059956_18390_t12.jpg")
        ...
        ########3Backgroung image
        img3=Image.open(r"C:\Users\dell\Desktop\Face Recognition system\college_images/backgroung.jpg")
        ...
        img_left=Image.open(r"C:\Users\dell\Desktop\Face Recognition system\college_images/AdobeStock_303989091.jpeg")
        ...
        ##Current course 
        CURRENT_course_frame=LabelFrame(Left_frame,bd=2,relief=RIDGE,bg="white",text="Current Course info",font=("times new roman",12,"bold"))
        ...
        course_combo["values"]=("select Course","Computer","FE","SE","TE","CSD","BE","EC")
        ...
        year_combo=ttk.Combobox(CURRENT_course_frame,textvariable=self.var_year,font=("times new roman",13,"bold"),width=17,state="read only")
        ...
        #### student info frame
        Class_student=LabelFrame(Left_frame,bd=2,relief=RIDGE,bg="white",text="Class Student Information",font=("times new roman",12,"bold"))
        Class_student.place(x=5,y=250,width=720,height=300) 
        
        #########Student id
        
        semesterid_label=Label(Class_student,text="Student Id",font=("times new roman",13,"bold"),bg="white")
        semesterid_label.grid(row=0,column=0,padx=10,pady=5,sticky=W)
        
        Studentid_entery=ttk.Entry(Class_student,textvariable=self.var_std_id,width=20,font=("times new roman",13,"bold"))
        ...
        Studentname_entery=ttk.Entry(Class_student,textvariable=self.var_std_name,width=20,font=("times new roman",13,"bold"))
        ...
        div_combo=ttk.Combobox(Class_student,textvariable=self.var_div,font=("times new roman",13,"bold"),width=18,state="read only")
        ...
        roll_no_entery=ttk.Entry(Class_student,textvariable=self.var_roll,width=20,font=("times new roman",13,"bold"))
        ...
        gender_combo=ttk.Combobox(Class_student,textvariable=self.var_gender,font=("times new roman",13,"bold"),width=18,state="read only")
        ...
        dob_entery=ttk.Entry(Class_student,width=20,textvariable=self.var_dob,font=("times new roman",13,"bold"))
        ...
        email_entery=ttk.Entry(Class_student,textvariable=self.var_email,width=20,font=("times new roman",13,"bold"))
        ...
        phone_entery=ttk.Entry(Class_student,textvariable=self.var_phone,width=20,font=("times new roman",13,"bold"))
        ...
        address_entery=ttk.Entry(Class_student,textvariable=self.var_address,width=20,font=("times new roman",13,"bold"))
        ...
        teacher_entery=ttk.Entry(Class_student,textvariable=self.var_teacher,width=20,font=("times new roman",13,"bold"))
        ...
        img_right=Image.open(r"C:\Users\dell\Desktop\Face Recognition system\college_images/gettyimages-1022573162.jpg")
        ...
        Search_entery=ttk.Entry(Search_Frame,width=15,font=("times new roman",13,"bold"))
        ...
        self.student_table=ttk.Treeview(table_Frame,column=("dep","Course","year","sem","id","name","divi","roll","gender","dob","email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if update>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="navedkhan8888",database="face_recognition")
                    my_cursor=conn.cursor()
                    my_cursor.execute("Update student set dep=%s,Course=%s,year=%s,sem=%s,name=%s,divi=%s,roll=%s,gender=%s,dob=%s,email=%s,phone=%s,address=%s,teacher=%s,photo=%s  where id=%s",(
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                #################33Load predefined data face frotel from opencv
                face_classifier=cv2.CascadeClassifier(r"c:\Users\dell\Desktop\Face Recognition system\haarcascade_frontalface_default.xml")
                def face_cropped(img):
                    gray=cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)
                    faces=face_classifier.detectMultiScale(gray,1.3,5)
                    #scaling factor=1.3  cv2.COLOR_BGR2GRAY
                    #Minimum Neighbor=5  cv2.COLOR_BAYER_BG2BGR
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        file_name_path=r"c:\Users\dell\Desktop\Face Recognition system\data/user."+str(id)+"."+str(img_id)+".jpg"
